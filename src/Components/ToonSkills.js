...
const ToonSkills = (props) => {
  ...
  return (
    <div className="ToonSkills">
      ...
      <div className="skillsRight" id="a5Skills"><br></br>Skills</div>
      <div className="skillsRight" id="a6Skills"><br></br>Skills</div>
    </div>
  );
}

export default ToonSkills;